...
// Type: Number.
export const __ELM_WATCH_OPEN_EDITOR_TIMEOUT_MS = "__ELM_WATCH_OPEN_EDITOR_TIMEOUT_MS";
...
// Type: Number.
export const __ELM_WATCH_LOADING_MESSAGE_DELAY = "__ELM_WATCH_LOADING_MESSAGE_DELAY";
// Used to speed up tests by not having to wait for a long time to test worker limiting.
// Type: Number.
export const __ELM_WATCH_WORKER_LIMIT_TIMEOUT_MS = "__ELM_WATCH_WORKER_LIMIT_TIMEOUT_MS";
// Used in tests to exit on first worker limit (instead of continuing watching).
// Type: Check if defined and ignore value.
export const __ELM_WATCH_EXIT_ON_WORKER_LIMIT = "__ELM_WATCH_EXIT_ON_WORKER_LIMIT";
...
// Type: Number.
export const __ELM_WATCH_QUERY_TERMINAL_TIMEOUT_MS = "__ELM_WATCH_QUERY_TERMINAL_TIMEOUT_MS";
// Used in tests to test reusing of a recent terminal query.
// Type: Number.
export const __ELM_WATCH_QUERY_TERMINAL_MAX_AGE_MS = "__ELM_WATCH_QUERY_TERMINAL_MAX_AGE_MS";
