...
import { assertExitCode, clean, CursorWriteStream, logDebug, MemoryWriteStream, SilentReadStream, stringSnapshotSerializer, TEST_ENV, } from "./Helpers";
async function helpHelper(args, env = process.env) {
