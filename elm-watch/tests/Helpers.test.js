import { formatDate, formatTime, printDurationMs, printFileSize, unknownErrorToString, } from "../src/Helpers";
...
describe("Helpers", () => {
    ...
    describe("unknownErrorToString", () => {
        ...
        test("just a string", () => {
            expect(unknownErrorToString("some error string")).toBe('"some error string"');
        });
        test("undefined", () => {
